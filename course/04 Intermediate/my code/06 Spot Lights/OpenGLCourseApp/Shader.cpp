...
void Shader::setSpotLights(SpotLight * sLight, unsigned int lightCount)
{
	...
	for (size_t i = 0; i < lightCount; i++)
	{
		sLight[i].UseLight(uniformSpotLights[i].uniformAmbentIntensity, uniformSpotLights[i].uniformColour, uniformSpotLights[i].uniformDiffuseIntensity,
			uniformSpotLights[i].uniformPosition, uniformSpotLights[i].uniformDirection, uniformSpotLights[i].uniformConstant,
			uniformSpotLights[i].uniformLinear, uniformSpotLights[i].uniformExponent, uniformSpotLights[i].uniformEdge);
	}
}
...
void Shader::CompileShader(const char * vertexCode, const char * fragmentCode)
{
	...
	for (size_t i = 0; i < MAX_SPOT_LIGHTS; i++)
	{
		...
		uniformSpotLights[i].uniformAmbentIntensity = glGetUniformLocation(shaderID, locBuff);
